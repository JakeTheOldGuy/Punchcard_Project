...
-- Drop dependent tables first (reverse order of dependencies)
IF OBJECT_ID('ChangeLog', 'U') IS NOT NULL
    DROP TABLE ChangeLog;

IF OBJECT_ID('MilesLog', 'U') IS NOT NULL
    DROP TABLE MilesLog;

IF OBJECT_ID('WeekLog', 'U') IS NOT NULL
    DROP TABLE WeekLog;

IF OBJECT_ID('AbsenceRecord', 'U') IS NOT NULL
    DROP TABLE AbsenceRecord;

IF OBJECT_ID('PunchRecord', 'U') IS NOT NULL
...
CREATE TABLE Employee (
    ...
    four_digit_code VARCHAR(4) UNIQUE,
    employee_role VARCHAR(50)
);

-- Recreate the dependent tables
CREATE TABLE PunchRecord (
    punch_id VARCHAR(50) PRIMARY KEY,
...
CREATE TABLE MilesLog (
    miles_id VARCHAR(50) PRIMARY KEY,
    employee_id INT FOREIGN KEY REFERENCES Employee(employee_id),
    week_id VARCHAR(50),
    miles_date DATE,
...
INSERT INTO AbsenceRecord (absence_id, employee_id, absence_type, absence_date, notes)
VALUES
    -- Data for Employee 101
...
INSERT INTO WeekLog (week_id, employee_id, week_ending_day, total_hours, overtime, weighted_hours)
VALUES
